...
class MyHandler(FileSystemEventHandler):
    def on_created(self, event):
        ...
        open_by_file(r'C:\Users\Osama hosam\Desktop\gg\OCR+FormatFilling\OCR+FormatFilling\Document_fill\json_to_doc.py',extracted_text)
        open_by_file(r'C:\Users\Osama hosam\Desktop\gg\OCR+FormatFilling\OCR+FormatFilling\CSV_fill\jcsv.py',extracted_text)
...
if __name__ == "__main__":
    path = r'C:\Users\Osama hosam\Desktop\gg\OCR+FormatFilling\OCR+FormatFilling\imgs'  # Folder to monitor
