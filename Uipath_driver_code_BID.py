...
def do_myocr(img_path , ocr_model):
    ...
    api_key = os.getenv("api_key_4")  # Replace with your API key
...
def main():
    try:
        ...
        extracted_text=do_myocr(file_path , 2)
        open_by_file(rf"D:\Grad\OCR-RPA\Document_fill\json_to_doc_BID_ui.py",extracted_text)
        open_by_file(rf"D:\Grad\OCR-RPA\CSV_fill\jcsv_BID_ui.py",extracted_text)
